...
CREATE TABLE [kchris12].[EMPLOYEE2](
	...
	CHECK (NOT ([ISADMIN] = 0 AND [IS_SUPER_ADMIN] = 1))
)
GO

ALTER TABLE [kchris12].[FAQ]
ADD PDF_NAME varchar(255);

GO

Create table POLICIES(
POLICY_ID INT IDENTITY(1,1),
POLICY_NAME NVARCHAR(500),
POLICY_PDF_NAME NVARCHAR(500)
)
